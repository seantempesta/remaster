...
- **Checkpoint:** `checkpoints/drunet_teacher/best.pth` (124.5 MB, key='params')
...
- **Data:** 1224 training pairs + 33 val pairs in `data/train_pairs/` and `data/val_pairs/` (input/ + target/)
- **Cloud:** Modal with A10G ($1.10/hr). Script: `cloud/modal_train_plainnet.py`
...
- `data/train_pairs/` — 1224 training pairs (input/ + target/)
- `data/val_pairs/` — 33 validation pairs
